<%@ Page Title="" Language="C#" MasterPageFile="~/StayelloDesign/UserMaster.master" AutoEventWireup="true" CodeFile="bookaura.aspx.cs" Inherits="StayelloDesign_aura" %>
                ...
                <div class="container">
                   ...
                   <div class="row">
                        <div class="col-sm-6 border-right-colored">
                            ...
                            <h6 class="text-center">Single <b style="color: #ffde00;">|</b>  Double Sharing </h6>
                            <p class="text-center">Starting from <b style="color: #00adef">15500 &#8377 </b><b style="color: #ffde00;">|</b>  Starting from <b style="color: #00adef">10000 &#8377 </b></p>
                        </div>
                        <div class="col-sm-6">
                            <h4 class="text-center colored">NON A.C</h4>
                            <h6 class="text-center">Single <b style="color: #ffde00;">|</b>  Double Sharing </h6>
                            <p class="text-center">Starting from <b style="color: #00adef">14000 &#8377 </b><b style="color: #ffde00;">|</b>  Starting from <b style="color: #00adef">8500 &#8377 </b></p>
                        </div>
                    </div>
...
10 &#8377;/ unit
                            ...
                            <div class="columnnew">
                                <table class="amenity-card">
                                    <tr>
                                        <td>
                                            <section class="icon-cover">
                                                <img src="infrastructure/img/myicons/lift.png" class="am-image">
                                            </section>
                                        </td>
                                        <td>
                                            <section class="includes">
                                                <p class="text-left" style="color: #007bff; font-size: 13px;">Lift</p>
                                            </section>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="columnnew">
                                <table class="amenity-card">
                                    <tr>
                                        <td>
                                            <section class="icon-cover">
                                                <img src="infrastructure/img/myicons/tv.png" class="am-image">
                                            </section>
                                        </td>
                                        <td>
                                            <section class="includes">
                                                <p class="text-left " style="color: #007bff; font-size: 13px;">TV</p>
                                            </section>
                                        </td>
                                    </tr>
                                </table>
            ...
            <div class="col-sm-5"  style="margin-top: 8%">
                <div class="fixed-calendar">
                    <h4 class="p-2" style="margin-bottom: 0px; color: #007bff">Stayello-aura </h4>
                        ...
                        <div class="tab-content">
                            <div id="tab1" class="tab-pane fade in active show">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtProperty" runat="server" class="form-control" ForeColor="#3366ff" ReadOnly="true" Text="Stayello-aura"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="vdate" class="color">Booking Amount <span style="color: #100202">(Left Blank if you scheduling visit)</span></label>
