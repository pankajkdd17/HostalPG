<%@ Page Title="" Language="C#" MasterPageFile="~/StayelloDesign/UserMaster.master" AutoEventWireup="true" CodeFile="Visitangel.aspx.cs" Inherits="StayelloDesign_angel" %>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 border-right-colored">
                            ...
                            <h6 class="text-center"> Double Sharing <b style="color: #ffde00;">|</b> Triple Sharing </h6>
                            <p class="text-center">Starting from <b style="color: #00adef">9000 &#8377 </b><b style="color: #ffde00;">|</b> Starting from <b style="color: #00adef">7500 &#8377 </b></p>
                        </div>
                        <div class="col-sm-6">
                            <h4 class="text-center colored">NON A.C</h4>
                            <h6 class="text-center">Double Sharing <b style="color: #ffde00;">|</b> Triple Sharing</h6>
                            <p class="text-center">Starting from <b style="color: #00adef">7500 &#8377 </b><b style="color: #ffde00;">|</b> Starting from <b style="color: #00adef">6000 &#8377 </b></p>
                        </div>
                    </div>
...
10 &#8377;/ unit
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">Fully Furnished Rooms</h5>
                                                <div>
                                                    Includes bed ,chair ,table ,wardrobe,bedsheet,pillow.
                                                </div>
                                            </section>
                                        </td>
                                    </tr>
                            ...
                            <div class="col-sm-6">
                                <table class="amenity-card">
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">House Keeping</h5>
                                                <div>
                                                    Thrice a week.
                                                </div>
                                            </section>
                            ...
                            <div class="col-sm-6">
                                <table class="amenity-card">
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">CCTV</h5>
                                                <div>
                            ...
                            <div class="col-sm-6">
                                <table class="amenity-card">
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">Wifi</h5>
                                                <div>
                            ...
                            <div class="col-sm-6">
                                <table class="amenity-card">
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">Parking</h5>
                                                <div>
                                                    2-Wheeler Parking
                                                </div>
                                            </section>
                            ...
                            <div class="col-sm-6">
                                <table class="amenity-card">
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">Washing Machine</h5>
                                                <div>
                                                    High Speed ,unlimited wifi.
                                                </div>
                                            </section>
                            ...
                            <div class="col-sm-6">
                                <table class="amenity-card">
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">Power Backup</h5>
                                                <div>
                                                    Limied Power Available
                                                </div>
                                            </section>
                                        </td>
                                    </tr>
                            ...
                            <div class="col-sm-6">
                                <table class="amenity-card">
                                    <tr>
                                        ...
                                        <td>
                                            <section class="includes">
                                                <h5 class="text-left text-muted">Drinking Water</h5>
                                                <div>
                                                    R.O water available.
                                                </div>
                                            </section>
            ...
            <div class="col-sm-5" style="margin-top: 8%">
                <div class="fixed-calendar">
                    <h4 class="p-2" style="margin-bottom: 0px; color: #007bff">Stayello-angel </h4>
                        ...
                        <div class="tab-content">
                            <div id="tab1" class="tab-pane fade in active show">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtProperty" runat="server" class="form-control" ForeColor="#3366ff" ReadOnly="true" Text="Stayello-angel"></asp:TextBox>
                                </div>
                                <div class="form-group">
