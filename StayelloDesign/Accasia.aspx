<%@ Page Title="" Language="C#" MasterPageFile="~/StayelloDesign/UserMaster.master" AutoEventWireup="true" CodeFile="Accasia.aspx.cs" Inherits="StayelloDesign_Accasia" %>
                        ...
                        <div class="tab-content">
                            <div id="tab1" class="tab-pane fade in active show">
                                ...
                                <div class="row" style="margin-left: -30%">
                                    <div class="columnbtn">
                                        <asp:Button ID="btnVisiting" runat="server" Text="Visit Now" OnClick="btnVisiting_Click" class="btn btn-primary mt-1" />

                                    </div>
                                    <div class="columnbtn">
                                        <asp:Button ID="Button1" runat="server" Text="Book Now" OnClick="btnBookNow_Click" class="btn btn-primary mt-1 form-btn-space"  />
