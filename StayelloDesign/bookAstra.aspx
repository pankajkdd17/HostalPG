<%@ Page Title="" Language="C#" MasterPageFile="~/StayelloDesign/UserMaster.master" AutoEventWireup="true" CodeFile="bookAstra.aspx.cs" Inherits="StayelloDesign_Astra" %>
                        ...
                        <div class="tab-content">
                            <div id="tab1" class="tab-pane fade in active show">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtProperty" runat="server" class="form-control" ForeColor="#3366ff" ReadOnly="true" Text="Stayello-Astra"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RangeValidator ID="RangeValidator1" runat="server"
                                        ...
                                        ErrorMessage="Minimum Booking Amount Is 1000 Rs-/"
                                        MinimumValue="1000" MaximumValue="20000" Type="Integer" Display="Dynamic" ForeColor="red" ValidationGroup="book"></asp:RangeValidator>
