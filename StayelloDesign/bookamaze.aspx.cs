...
public partial class StayelloDesign_amaze : System.Web.UI.Page
{
    ...
    private void addBooking()
    {
        ...
        if (txtbookingAmount.Text.Length >= 2)
        {
            ...
            txtProperty.Text = "Stayello-Amaze";
            try
            {
        ...
        {
            lblbookmsg.Text = "Please Enter Minimum 10 Rs-/ Of Booking Amount";
        }
    }
