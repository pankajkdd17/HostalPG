<%@ Page Title="" Language="C#" MasterPageFile="~/StayelloDesign/UserMaster.master" AutoEventWireup="true" CodeFile="bookAccasia.aspx.cs" Inherits="StayelloDesign_Accasia" %>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 border-right-colored">
                            ...
                            <h6 class="text-center">Single | Double Sharing | Triple Sharing </h6>
                            <p class="text-center">Starting from <b style="color: #f00">9000 &#8377 </b>| Starting from <b style="color: #f00">8000 &#8377 </b>| Starting from <b style="color: #f00">7000 &#8377 </b></p>
                        </div>
                        <div class="col-sm-6">
                            <h4 class="text-center colored">NON A.C</h4>
                            <h6 class="text-center">Single| Double Sharing | Triple Sharing</h6>
                            <p class="text-center">Starting from <b style="color: #f00">8000 &#8377 </b>| Starting from <b style="color: #f00">7000 &#8377 </b>| Starting from <b style="color: #f00">6000 &#8377 </b></p>
                        </div>
                    </div>
...
10 &#8377;/ unit
            ...
            <div class="col-sm-5"  style="margin-top: 8%">
                <div class="fixed-calendar">
                    <h4 class="p-2" style="margin-bottom: 0px; color: #007bff">Stayello-Accasia </h4>
                        ...
                        <div class="tab-content">
                            <div id="tab1" class="tab-pane fade in active show">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtProperty" runat="server" class="form-control" ForeColor="#3366ff" ReadOnly="true" Text="Stayello-Accasia"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlroomtype" runat="server" class="form-control">
                                        ...
                                        <asp:ListItem Text="Five Sharing" Value="5"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="alert alert-danger" runat="server" id="lblError" style="display: none;">
                                    ...
                                    <strong>Oh snap!</strong>Transection is pending  Booking not confirmed.
                                </div>
                            </div>
                        </div>
                    </div>
